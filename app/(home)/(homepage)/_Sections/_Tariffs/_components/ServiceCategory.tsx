...
export default function ServiceCategory({ category, categoryIndex }: any) {
    // Array di gradienti colorati
    const gradients = [
        // Dark vibes
        'from-red-950 via-red-800 to-red-600',          // Sangue antico
        'from-zinc-950 via-gray-800 to-zinc-600',       // Ferro consumato
        'from-cyan-950 via-cyan-800 to-cyan-600',       // Abisso oceanico
        'from-emerald-950 via-emerald-800 to-emerald-600', // Selva oscura
        'from-amber-600/90 via-yellow-800/70 to-yellow-950/50 backdrop-blur-lg', // Oro fuso
        'from-amber-600/80 via-orange-800/70 to-red-950/60 backdrop-blur-lg',   // Forgiato nel fuoco
    ];


    // Seleziona il gradiente in base all'indice (ciclico)
    ...
    return (
        ...
        >
            ...
            {/* Header Categoria con gradiente dinamico */}
            ...
            <div className="p-6">
                {category.items && category.items.length > 0 ? (
                    category.items.map((service: any, serviceIndex: number) => (
                        <ServiceItem
