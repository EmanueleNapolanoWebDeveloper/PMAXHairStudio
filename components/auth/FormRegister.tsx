                ...
                <div className="w-full max-w-full px-3 mx-auto mt-0 md:flex-0 shrink-0">
                    <div className="relative z-0 flex flex-col min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
                        <div className="p-6 mb-0 text-center bg-white border-b-0 rounded-t-2xl">
                            <h5 className='text-red-800'>Registrati con</h5>
                        </div>
                        <div className="flex flex-wrap px-3 -mx-3 sm:px-6 xl:px-12">
                            ...
                            <div className="relative w-full max-w-full px-3 mt-2 text-center shrink-0">
                                <p className="z-20 inline px-4 mb-2 font-semibold leading-normal bg-white text-sm text-red-800">oppure</p>
                            </div>
                        </div>
                        <div className="flex-auto p-6">

                            {/* inizio form */}
                            <form role="form text-left" method='POST' onSubmit={handleSubmit}>

                                {/* input name */}
                                <div className="mb-4">
                                    <input aria-describedby="email-addon" aria-label="Name" name='name' placeholder="Name" className="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow" type="text" />
                                </div>

                                {/* input email */}
                                <div className="mb-4">
                                    <input aria-describedby="email-addon" aria-label="Email" name='email' placeholder="Email" className="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow" type="email" />
                                </div>

                                {/* input password */}
                                <div className="mb-4">
                                    <input aria-describedby="password-addon" aria-label="Password" name='password' placeholder="Password" className="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow" type="password" />
                                </div>
                                ...
                                <p className="mt-4 mb-0 leading-normal text-sm">Already have an account?
                                    <Link className="font-bold text-slate-700" href="/login">Sign in</Link>
                                </p>
                            </form>
                        </div>
                    </div>
