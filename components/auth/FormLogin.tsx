...
const FormLogin = () => {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (result.status === 'success') {
      router.push('/')
      console.log('Accesso Effettutato!');
    } else {
      ...
      <form className="form" method='POST' onSubmit={handleSubmit} >
        ...
        <div className="flex-column">
          ...
          <div className="inputForm">
            ...
            <input type="text" name='email' className="input text-black" placeholder="Inserisci e-mail" />
            {/* error */}
          </div>
        ...
        <div className="flex-column">
          ...
          <div className="inputForm">
            ...
            <input type="password" name='password' className="input text-black" placeholder="Inserisci Password" />
