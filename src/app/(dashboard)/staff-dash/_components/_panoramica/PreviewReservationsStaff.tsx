...
import type { DashBoardContentProps } from "./DashboardContent";
import type { StatusKey } from "../../page";

type PreviewReservationsStaffProps = {
    todayReservations: DashBoardContentProps['reservations'];
    getStatusIcon: (status: StatusKey) => React.ComponentType<React.SVGProps<SVGSVGElement>>;
    getStatusColor: (status: StatusKey) => string;
};


export default function PreviewReservationsStaff({ todayReservations, getStatusIcon, getStatusColor }: PreviewReservationsStaffProps) {
