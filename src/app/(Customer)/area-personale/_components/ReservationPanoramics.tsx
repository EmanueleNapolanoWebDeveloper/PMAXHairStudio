...
const ReservationPanoramics = ({ reservations, setIsModalOpen, setSelectedReservation, reviews, onDelete }: ReservationPanoramicProps) => {
      ...
      {filteredReservations?.length === 0 ? (
        ...
        <div className="space-y-4">
          {filteredReservations?.map(reservation => {
            // Trova la review associata a questa prenotazione
